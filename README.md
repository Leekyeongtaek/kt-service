...
* 깃 컨벤션을 준수하고, 커밋 이력 추적이 가능한 단위별로 커밋 메시지 작성해보기
* 단위 테스트, 통합 테스트 작성 경험
* 로컬 환경에서 CI/CD 파이프라인 구현 경험
* 강의나 책을 통해 학습한 내용은 요구사항 정의 -> 구현 단계를 통한 실전 학습 파이프라인
...
## 3. 시스템 아키텍처
![System Architecture](./images/my-image2.png)
